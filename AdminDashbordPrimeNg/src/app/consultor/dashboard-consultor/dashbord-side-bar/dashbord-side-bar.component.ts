...
ngOnInit(): void {
  this.isEntreprise = this.authService.checkRole('entreprise'); // Check if the logged-in user has the 'entreprise' role
  this.isConsultor = this.authService.checkRole('consultor'); // Check if the logged-in user has the 'entreprise' role
  this.isAdmin = this.authService.checkRole('admin'|| 'superadmin'); // Check if the logged-in user has the 'entreprise' role
