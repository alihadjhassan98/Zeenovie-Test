...
import { AddTrainingQualifiicationsComponent } from './ResumeData/trainings-qualifications/add-training-qualifiications/add-training-qualifiications.component';
import { UpdateTrainingQualifiicationsComponent } from './ResumeData/trainings-qualifications/update-training-qualifiications/update-training-qualifiications.component';
import { AddProExperienceComponent } from './ResumeData/pro-experience/add-pro-experience/add-pro-experience.component';
import { UpdateProExperienceComponent } from './ResumeData/pro-experience/update-pro-experience/update-pro-experience.component';
import { DateRangePipe } from 'src/app/pipes/date-range.pipe';
import { UpdateSkillsComponent } from './ResumeData/skills/update-skills/update-skills.component';
import { AddSkillsComponent } from './ResumeData/skills/add-skills/add-skills.component';
import { AddLanguagesComponent } from './ResumeData/language/add-languages/add-languages.component';
import { UpdateLanguagesComponent } from './ResumeData/language/update-languages/update-languages.component';
...
@NgModule({
  declarations: [
    ...
    AddTrainingQualifiicationsComponent,
    UpdateTrainingQualifiicationsComponent,
    AddProExperienceComponent,
    UpdateProExperienceComponent,
